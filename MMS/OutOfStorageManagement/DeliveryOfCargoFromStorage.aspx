<%@ Page Title="" Language="C#" MasterPageFile="~/index.Master" AutoEventWireup="true" CodeBehind="DeliveryOfCargoFromStorage.aspx.cs" Inherits="mms.OutOfStorageManagement.DeliveryOfCargoFromStorage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:HiddenField ID="HiddenField" runat="server" Value="库存管理-->物资出库" ClientIDMode="Static" />
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        <script type="text/javascript">
            ...
            function confirmWindow(sender, args) {
                ...
                if (length == 0) {
                    $find("<%=RadNotificationAlert.ClientID%>").set_text("没有可出库的物资信息！");
    ...
    <div style="width: 100%;">
        ...
        <telerik:RadTabStrip ID="RadTabStrip1" runat="server" MultiPageID="RadMultiPage1" ShowBaseLine="true" Skin="Default">
            <Tabs>
                <telerik:RadTab Value="0" Text="扫码出库" Selected="true"></telerik:RadTab>
                <telerik:RadTab Value="1" Text="查询库存出库"></telerik:RadTab>
            </Tabs>
        </telerik:RadTabStrip>
                        ...
                        <telerik:RadGrid ID="RadGrid1" runat="server" AutoGenerateColumns="false" OnNeedDataSource="RadGrid1_NeedDataSource"
                            ...
                            <MasterTableView CommandItemDisplay="Top" DataKeyNames="ID">
                                <Columns>
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="出库数量">
                                        <ItemTemplate>
                                ...
                                <CommandItemTemplate>
                                    出库物资信息列表
                                <telerik:RadButton ID="RB_Add2" runat="server" Text="出库" CssClass="floatright" OnClientClicking="confirmWindow" CommandName="add"></telerik:RadButton>
                                </CommandItemTemplate>
                                <CommandItemStyle HorizontalAlign="Center" Font-Size="14px" Font-Bold="true" />
                            </MasterTableView>
                        </telerik:RadGrid>
                    </div>
                </div>
                    ...
                    <div style="width: 100%;">
                        <telerik:RadGrid ID="RadGrid2" runat="server" AutoGenerateColumns="false" AllowPaging="true"
                            ...
                            <MasterTableView CommandItemDisplay="Top" DataKeyNames="ID">
                                ...
                                <CommandItemTemplate>
                                    库存物资信息列表
                                <telerik:RadButton ID="RB_Add2" runat="server" Text="出库" CssClass="floatright" OnClientClicking="confirmWindow2" CommandName="add"></telerik:RadButton>
                                </CommandItemTemplate>
                                <CommandItemStyle HorizontalAlign="Center" Font-Size="14px" Font-Bold="true" />
                            </MasterTableView>
                        </telerik:RadGrid>
        ...
        <ContentTemplate>
            <div style="margin-top: 30px; float: left;">
                ...
                <div style="width: 200px; float: left;">
                    <asp:Label ID="Label1" Font-Size="14px" Text="确定要出库吗？" runat="server" Font-Bold="true"
                        ForeColor="#25a0da" />
                    <br />
                    <br />
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
