...
namespace mms.Plan
{
    public partial class TechnologyInnovateAdd : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                GridSource = Common.AddTableRowsID(GetTechnologyTestList(this.hfBh.Value));
                BindDDlDept();
        ...
        private void SaveTechnologyInnovateInfo()
        {
        ...
        protected void SaveTechnologyNoSubmit(M_Demand_Merge_List mta)
        {
            ...
            try
            {
                ...
                RadNotificationAlert.Show();
                GridSource = Common.AddTableRowsID(GetTechnologyTestList(mta.MDPId.ToString()));
                RadGrid_TechnologyInnovateList.Rebind();
            }
            catch (Exception ex)
            {
        ...
        protected void RadGrid_TechnologyInnovateList_ItemCommand(object sender, GridCommandEventArgs e)
        {
            ...
            if (e.CommandName == "delete")
            {
                ...
                GridSource = Common.AddTableRowsID(GetTechnologyTestList(MDPId));
                RadGrid_TechnologyInnovateList.DataSource = GridSource;
            }
        }
        ...
        protected void RadBtnSubmit_Click(object sender, EventArgs e)
        {
            if (this.hfBh.Value != null && this.hfBh.Value != "")
            {
                ...
                RadNotificationAlert.Show();
                //Response.Redirect("~/Plan/TechnologyInnovateList.aspx");
