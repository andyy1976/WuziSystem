                    ...
                    <div style="width: 100%;">
                        <table>
                            <tr>
                                <td>产品名称：</td>
                                <td>
                                    <telerik:RadTextBox ID="RTB_TDM_Description_BOM" runat="server" Width="100px"></telerik:RadTextBox></td>
                                <td>零件类型：</td>
                                <td>
                                ...
                                <td>图号：</td>
                                <td>
                                    <telerik:RadTextBox ID="RTB_Drawing_No_BOM" runat="server" Width="100px"></telerik:RadTextBox></td>
                                <td>领料部门：</td>
                                <td>
                                    <telerik:RadTextBox ID="RTB_MaterialDept_BOM" runat="server" Width="100px"></telerik:RadTextBox></td>
                                <td>
                        ...
                        <telerik:RadTreeList ID="RTL_BOM" runat="server" AutoGenerateColumns="false" DataKeyNames="Id"
                            ...
                            <Columns>
                               ...
                               <%-- <telerik:TreeListBoundColumn DataField="Material_Code" HeaderText="编号" SortExpression="Material_Code"></telerik:TreeListBoundColumn>  --%>
                                ...
                                <telerik:TreeListBoundColumn DataField="Rough_Size" HeaderText="物资尺寸"></telerik:TreeListBoundColumn>
                                <telerik:TreeListBoundColumn DataField="Rough_Spec" HeaderText="物资规格"></telerik:TreeListBoundColumn>
                                <telerik:TreeListBoundColumn DataField="DemandNumSum" HeaderText="共计需求量(kg)" ItemStyle-HorizontalAlign="Right"></telerik:TreeListBoundColumn>
                                <telerik:TreeListBoundColumn DataField="NumCasesSum" HeaderText="共计需求件数" ItemStyle-HorizontalAlign="Right"></telerik:TreeListBoundColumn>
                            </Columns>
                        </telerik:RadTreeList>
                    </div>
                </telerik:RadPageView>
                    ...
                    <div style="width: 100%;">
                        <table>
                            <tr>
                                <td>产品名称：</td>
                                <td>
                                    <telerik:RadTextBox ID="RTB_TDM_Description_Defect" runat="server" Width="100px"></telerik:RadTextBox></td>
                                <td>零件类型：</td>
                                <td>
                                ...
                                <td>图号：</td>
                                <td>
                                    <telerik:RadTextBox ID="RTB_Drawing_No_Defect" runat="server" Width="100px"></telerik:RadTextBox></td>
                                <td>
                    ...
                    <div style="width: 100%; float: left;">
                        <telerik:RadTreeList ID="RTL_Defect" runat="server" AutoGenerateColumns="false" DataKeyNames="Id"
                            ...
                            <Columns>
                                ...
                                <telerik:TreeListBoundColumn DataField="DemandNumSum" HeaderText="共计需求量(kg)" ItemStyle-HorizontalAlign="Right"></telerik:TreeListBoundColumn>
                                <telerik:TreeListBoundColumn DataField="NumCasesSum" HeaderText="共计需求件数" ItemStyle-HorizontalAlign="Right"></telerik:TreeListBoundColumn>
                                <telerik:TreeListBoundColumn DataField="MissingDescription" HeaderText="却定额不规范说明"></telerik:TreeListBoundColumn>
                    ...
                    <div style="width: 100%;">
                        <table>
                            <tr>
                                <td>产品名称：</td>
                                <td>
                                    <telerik:RadTextBox ID="RTB_TDM_Description_SubmitState" runat="server" Width="100px"></telerik:RadTextBox></td>
                                <td>零件类型：</td>
                                <td>
                                ...
                                <td>图号：</td>
                                <td>
                                    <telerik:RadTextBox ID="RTB_Drawing_No_SubmitState" runat="server" Width="100px"></telerik:RadTextBox></td>
                                <td>提交状态：</td>
                                <td>
