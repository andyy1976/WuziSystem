<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeBehind="TechnologyInnovateAdd.aspx.cs" Inherits="mms.Plan.TechnologyInnovateAdd" %>
        ...
        <div style="width: 100%; float: left;">
            <div class="divContant">
                ...
                <telerik:RadAjaxManager ID="RadAjaxManager1" runat="server">
                    <AjaxSettings>
                        ...
                        <%--<telerik:AjaxSetting AjaxControlID="btn_ItemCodeOK">
                            <UpdatedControls>
                                ...
                                <telerik:AjaxUpdatedControl ControlID="txt_Rough_Size" />
                                <telerik:AjaxUpdatedControl ControlID="txt_Unit_Price" />
                            </UpdatedControls>
                        </telerik:AjaxSetting>--%>
                    </AjaxSettings>
                </telerik:RadAjaxManager>
                <telerik:RadAjaxLoadingPanel ID="RadAjaxLoadingPanelLoading" runat="server"></telerik:RadAjaxLoadingPanel>
                <asp:HiddenField ID="HiddenField1" runat="server" Value="天津公司技术创新课题任务-->技术创新课题列表" ClientIDMode="Static" />
            </div>
            <div class="divContant">
                <div class="technology_Div_content">
                    <div class="technology_Div_title"><b>技术创新课题领用申请</b></div>
                    <div>
            ...
            <div class="divContant">
                <div style="width: 100%; text-align: center;margin-top:20px;margin-bottom:20px;">
                    <b style="font-size: 22px;">技术创新课题未提交申请</b>
                </div>
