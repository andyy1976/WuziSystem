...
namespace mms.MaterialApplicationCollar
{
    public partial class MaterialApplicationQuery : System.Web.UI.Page
    {
        ...
        public void GetMA()
        {
            string strSQL = "select Convert(nvarchar(50),ApplicationTime, 111) as ApplicationTime, Convert(nvarchar(50),FeedingTime, 111) as FeedingTime,MaterialApplication.*, case when AppState = '1' then '已申请,未审批' when AppState='2' then '进入流程平台' when AppState='3' then '取消审批'"
