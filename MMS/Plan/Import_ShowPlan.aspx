        ...
        <script type="text/javascript">
            ...
            function ImportMaterial(sender, args) {
                ...
                if (selectedItems.length <= 0) {
                    ...
                    window.radopen("/Plan/Import_MaterialRequirement.aspx?PackId=" + PackId, "RadWindowImportMaterialWindow");
                }
            }
            ...
            function ChangeMaterialQuota(PackId) {
                window.location.href = "/Plan/ChangeMaterialQuota.aspx?PackId=" + PackId + "&fromPage=1";
            }
            function ShowM_Change(PackId) {
                window.location.href = "/Plan/ShowM_Change.aspx?PackId=" + PackId;
            }
            function ShowMDemandDetails(PackId) {
                window.location.href = "/Plan/Import_MDemandDetails.aspx?PackId=" + PackId+"&fromPage=1";
            }
            //需求变更
            function ShowMDemandMergeListUpdate(PackId) {
                window.location.href = "/Plan/MDemandMergeListChange.aspx?PackId=" + PackId + "&fromPage=1";
            }
                        ...
                        <telerik:GridTemplateColumn HeaderText="物资导入" ItemStyle-Width="120px" HeaderStyle-Width="120px">
                            ...
                            <ItemTemplate>
                                <telerik:RadButton ID="RB_ADD_1" runat="server" ButtonType="ToggleButton" Text="导入物资需求" ToolTip="点击通过Excel导入型号物资需求"
                                     CommandName="ImportFromExcel" Visible="false" ForeColor="blue">
                                </telerik:RadButton>
