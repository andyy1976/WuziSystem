<%@ Page Title="" Language="C#" MasterPageFile="~/index.Master" AutoEventWireup="true" CodeBehind="AuxiliaryMaterialList.aspx.cs" Inherits="mms.Plan.AuxiliaryMaterialList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:HiddenField ID="HiddenField" runat="server" Value="天津公司车间物资申请列表" ClientIDMode="Static" />
    <hr style="margin-top:0px;" />
    <div style="width: 100%; float: left;">
        <div class="divContant">
            <div class="divViewPanel">
                <asp:Button ID="btnNewAdd" runat="server" Text="新增物资申请" AutoPostBack="false"/>
            </div>
            <div class="divViewPanel">
                <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
                    <script type="text/javascript">
                        ...
                        function ShowAuxiliaryMaterialAdd(MDPId) {
                            var win = $find("<%=RadWindowRecordWindow1.ClientID %>");
                            win.set_title("新增工艺试验件");
                            window.radopen("/Plan/AuxiliaryMaterialAdd.aspx?MDPId=" + MDPId, "RadWindowRecordWindow1");
                            return false;
                        }
                    </script>
                ...
                <telerik:RadAjaxManager ID="RadAjaxManager1" runat="server">
                    ...
                    <AjaxSettings>
                        <telerik:AjaxSetting AjaxControlID="RadGrid_AuxiliaryMaterialList">
                            <UpdatedControls>
                                <telerik:AjaxUpdatedControl ControlID="RadGrid_AuxiliaryMaterialList" LoadingPanelID="RadAjaxLoadingPanelLoading" />
                ...
                <telerik:RadGrid ID="RadGrid_AuxiliaryMaterialList" runat="server" AllowPaging="True" DataKeyNames="ID" Culture="zh-CN" GroupPanelPosition="Top" 
                    ...
                    OnItemDataBound="RadGrid_AuxiliaryMaterialList_ItemDataBound">
                ...
                <telerik:RadWindowManager ID="RadWindowManager1" runat="server">
                    <Windows>
                        <telerik:RadWindow ID="RadWindowRecordWindow" runat="server" Title="物资" Left="100px"
                        ...
                        <telerik:RadWindow ID="RadWindowRecordWindow1" runat="server" Title="新增物资" Left="100px"
                            ReloadOnShow="true" ShowContentDuringLoad="false" VisibleTitlebar="true" VisibleStatusbar="false"
                            Behaviors="Close,Maximize,Minimize" Modal="true" Width="1300px" Height="620px" />
                    </Windows>
