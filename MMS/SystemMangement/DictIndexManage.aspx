<%@ Page Title="" Language="C#" MasterPageFile="~/index.Master" AutoEventWireup="true" CodeBehind="DictIndexManage.aspx.cs" Inherits="mms.SystemMangement.DictIndexManage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <telerik:RadGrid ID="RadGridDictIndex" runat="server" AllowPaging="True" Culture="zh-CN" GroupPanelPosition="Top" OnNeedDataSource="RadGridDictIndex_NeedDataSource" OnInsertCommand="RadGridDictIndex_InsertCommand" OnItemCommand="RadGridDictIndex_ItemCommand" OnItemDataBound="RadGridDictIndex_ItemDataBound" OnUpdateCommand="RadGridDictIndex_ItemUpdated" OnItemCreated="RadGridDictIndex_ItemCreated">
        <MasterTableView AutoGenerateColumns="False" DataKeyNames="ID" CommandItemDisplay="Top">
            <Columns>
                ...
                <telerik:GridBoundColumn DataField="TypeDes" FilterControlAltText="Filter TypeDes column" HeaderText="TypeDes" SortExpression="TypeDes" UniqueName="TypeDes">
                    <ColumnValidationSettings>
                        <ModelErrorMessage Text="" />
                    </ColumnValidationSettings>
                </telerik:GridBoundColumn>
            ...
            <CommandItemTemplate>
                <telerik:RadButton ID="RadButton_AddNew" runat="server" Text="新增" Font-Bold="true" CommandName="InitInsert"></telerik:RadButton>&nbsp;&nbsp;&nbsp;&nbsp;
                <telerik:RadComboBox ID="RadComboBoxTypeDes" runat="server" EmptyMessage="选择索引" AllowCustomText="True" Filter="Contains" AutoPostBack="True" Culture="zh-CN" DataSourceID="SqlDataSourceDictIndex" DataTextField="TypeDes" DataValueField="ID" OnItemDataBound="RadComboBoxTypeDes_ItemDataBound" OnSelectedIndexChanged="RadComboBoxTypeDes_SelectedIndexChanged"></telerik:RadComboBox>
                
            </CommandItemTemplate>
        </MasterTableView>
    </telerik:RadGrid>
    <asp:SqlDataSource ID="SqlDataSourceDictIndex" runat="server" ConnectionString="<%$ ConnectionStrings:MaterialManagerSystemConnectionString %>" SelectCommand="SELECT [ID], [TypeDes] FROM [Sys_DictIndex]"></asp:SqlDataSource>
