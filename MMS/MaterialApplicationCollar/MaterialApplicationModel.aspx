        ...
        <div style="width: 100%; float: left;">
            <table>
                <tr>
                 ...
                 <tr>
                    <td>提交人：</td>
                    <td><telerik:RadTextBox ID="RTB_Applicant" runat="server" Width="100px">
                          <ClientEvents OnKeyPress="EnterKeyProcessing" />
                        </telerik:RadTextBox>
                    </td>
                    <td>领用单位：</td>
                    <td><telerik:RadTextBox ID="RTB_App_Depart" runat="server" Width="100px">
                          <ClientEvents OnKeyPress="EnterKeyProcessing" />
                        </telerik:RadTextBox>
                    </td>
            ...
            <telerik:RadGrid ID="RadGridMDML" runat="server" AutoGenerateColumns="false" AllowMultiRowSelection="false"
			    ...
			    <CommandItemSettings ShowExportToExcelButton="true" ShowExportToWordButton="true" ShowExportToPdfButton="true" />
                    ...
                    <Columns>
                        ...
                        <telerik:GridBoundColumn DataField="Com_ProductName" HeaderText="产品名称" ColumnGroupName="ProductInfo" ItemStyle-Width="100px" HeaderStyle-Width="100px"></telerik:GridBoundColumn>
