    ...
    <div style="width: 100%; margin: 0px auto;">
        <table style="width:100%; float:left; text-align:left;">
            ...
            <tr>                
                ...
                <td><telerik:RadTextBox ID="RTB_hgz_no" runat="server" Width="100px"></telerik:RadTextBox></td>
                <td style="text-align:right;">任务号：</td>
                <td><telerik:RadTextBox ID="RTB_jc_rwh" runat="server" Width="100px"></telerik:RadTextBox></td>
                <td style="text-align:right;">图号：</td>
                <td><telerik:RadTextBox ID="RTB_jc_th" runat="server" Width="100px"></telerik:RadTextBox></td>
                <td style="text-align:right;">质检单号：</td>
                <td><telerik:RadTextBox ID="RTB_hgz_zjdbillno" runat="server" Width="100px"></telerik:RadTextBox></td>
                <td style="text-align:right;">质疑单号：</td>
                <td><telerik:RadTextBox ID="RTB_hgz_zydh" runat="server" Width="100px"></telerik:RadTextBox></td>
