                         ...
                         <telerik:RadButton ID="RB_Clear" runat="server" Text="清空"   Font-Bold="true" OnClick="RBClear_Click" OnClientClicking="ShowRadWindowClear" CssClass="floatright"></telerik:RadButton> 
                            ...
                            <Columns>
                                <telerik:GridClientSelectColumn UniqueName="ClientSelectColumn" ItemStyle-Width="30px" HeaderStyle-Width="30px"  >
                                    ...
                                    <telerik:GridBoundColumn DataField="Rough_Spec" ItemStyle-Width="100px" HeaderStyle-Width="100px" HeaderText="规格" SortExpression="Rough_Spec" UniqueName="Rough_Spec">
                                    </telerik:GridBoundColumn>
                                   ...
                                   <telerik:GridBoundColumn DataField="NumCasesSum" ItemStyle-Width="80px" HeaderStyle-Width="80px" HeaderText="需求件数" SortExpression="NumCasesSum" UniqueName="NumCasesSum">
                                    ...
                                    <telerik:GridBoundColumn DataField="Urgency_Degre" ItemStyle-Width="80px" HeaderStyle-Width="80px" HeaderText="紧急程度" SortExpression="Urgency_Degre" UniqueName="Urgency_Degre">
                                    </telerik:GridBoundColumn>
                                    ...
                                    <telerik:GridBoundColumn DataField="Use_Des" ItemStyle-Width="80px" HeaderStyle-Width="80px" HeaderText="用途" SortExpression="Use_Des" UniqueName="Use_Des">
                                    </telerik:GridBoundColumn>
                            ...
                            <MasterTableView AutoGenerateColumns="False" DataKeyNames="ID" CommandItemDisplay="Top">
                                <CommandItemSettings ShowExportToExcelButton="false" ShowAddNewRecordButton="false" ShowRefreshButton="false" />
                                 ...
                                 <Columns>
                                    ...
                                    <telerik:GridBoundColumn DataField="UrgencyDegre" ItemStyle-Width="80px" HeaderStyle-Width="80px" HeaderText="紧急程度" SortExpression="UrgencyDegre" UniqueName="UrgencyDegre">
                                    </telerik:GridBoundColumn>
                                    <telerik:GridBoundColumn DataField="Secret_Level" ItemStyle-Width="80px" HeaderStyle-Width="80px" HeaderText="密级" SortExpression="Secret_Level" UniqueName="Secret_Level">
                                    </telerik:GridBoundColumn>
                        ...
                        <div class="technology_Div_detailcontent">
                            <table border="0">
                                ...
                                <tr>
                                    ...
                                    <td class="technology_Div_detailcontent_content">
                                        <telerik:RadTextBox ID="txt_DemandNumSum" Width="150" runat="server" MaxLength="10" onpaste="return false" onkeyup='clearNoDecimal(this)'>
                                              <ClientEvents OnKeyPress="EnterKeyProcessing" />
                                        </telerik:RadTextBox>
                                    ...
                                    <td class="technology_Div_detailcontent_content">
                                        <telerik:RadTextBox ID="txt_NumCasesSum" ClientIDMode="Static" Width="150" runat="server" MaxLength="10" onpaste="return false" onkeyup='clearNoDecimal(this)'>
                                              <ClientEvents OnKeyPress="EnterKeyProcessing" />
                                        </telerik:RadTextBox>
                                ...
                                <tr>
                                    ...
                                    <td class="technology_Div_detailcontent_content">
                                        <telerik:RadTextBox ID="rtb_SpecialNeeds" runat="server" Width="150" MaxLength="50" EmptyMessage="无">
                                              <ClientEvents OnKeyPress="EnterKeyProcessing" />
                                        </telerik:RadTextBox>
