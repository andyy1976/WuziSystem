<%@ Page Title="" Language="C#" MasterPageFile="~/index.Master" AutoEventWireup="true" CodeBehind="PermissionManage.aspx.cs" Inherits="mms.SystemMangement.PermissionManage" %>
    ...
    <telerik:RadGrid ID="RadGrid_Permission" runat="server" Culture="zh-CN" GroupPanelPosition="Top" CellSpacing="-1" GridLines="Both" OnNeedDataSource="RadGrid_Permission_NeedDataSource" OnItemCommand="RadGrid_Permission_ItemCommand" OnItemDataBound="RadGrid_Permission_ItemDataBound">
      ...
      <CommandItemTemplate>
                ...
                <telerik:RadComboBox ID="RadComboBoxPermission" runat="server" AllowCustomText="True" Filter="Contains"
                     ...
                     OnSelectedIndexChanged="RadComboBoxPermission_SelectedIndexChanged"></telerik:RadComboBox>
            </CommandItemTemplate>
            <Columns>
