<%@ Page Title="" Language="C#" MasterPageFile="~/index.Master" AutoEventWireup="true" CodeBehind="SignFailed.aspx.cs" Inherits="mms.OutOfStorageManagement.SignFailed" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:HiddenField ID="HiddenField" runat="server" Value="出库单管理-->签收失败信息" ClientIDMode="Static" />
    ...
    <div style="width:100%;">
        <telerik:RadTabStrip ID="RadTabStrip1" runat="server" Skin="Default" ShowBaseLine="true">
            <Tabs>
                <telerik:RadTab Text="签收出库单" NavigateUrl="SignStockBill.aspx"></telerik:RadTab>
                <telerik:RadTab Text="签收失败信息" Selected="true" ></telerik:RadTab>
            </Tabs>
        </telerik:RadTabStrip>
    </div>
   <div style="width: 100%; margin: 20px auto;">
        <telerik:RadGrid ID="RadGrid1" runat="server" AutoGenerateColumns="false" AllowPaging="true" PageSize="20" PagerStyle-AlwaysVisible="True"
            ...
            <ClientSettings Selecting-AllowRowSelect="true" EnableRowHoverStyle="true">
                <Scrolling AllowScroll="True" UseStaticHeaders="True" FrozenColumnsCount="4" ScrollHeight="600px"></Scrolling>
            ...
            <MasterTableView CommandItemDisplay="Top" DataKeyNames="ID">
                ...
                <Columns>
                    <telerik:GridBoundColumn DataField="LastUpdate" HeaderText="签收失败时间" ItemStyle-Width="100px" HeaderStyle-Width="100px"></telerik:GridBoundColumn>
                    <telerik:GridBoundColumn DataField="errorInfo" HeaderText="签收失败原因" ItemStyle-Width="200px" HeaderStyle-Width="200px"></telerik:GridBoundColumn>
